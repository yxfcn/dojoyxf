...
map = new Map("ui-esri-map", {
    basemap: "topo",//基础底图
    center: [-94.75290067627297, 39.034671990514816],//初始化地图中心
    zoom: 12,//缩放等级
...
var geocoder = new Geocoder({
    arcgisGeocoder: {              //默认使用 esri world locator搜索位置
        placeholder: "Search"
    },
    map: map         //引用的地图对象
...
var _censusInfoContent =                        //定义infowindow内容样式，使用${fieldName:格式转换函数}代表值
...
demographicsLayer.setInfoTemplates({
    1: { infoTemplate: _blockGroupInfoTemplate },//图层序号为1的弹窗模板
