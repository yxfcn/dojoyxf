...
//天地图切片信息
const TDT_TILEINFO: TileInfo = new TileInfo({
    "dpi": 96,
...
//天地图范围
const TDT_EXTENT: Extent = new Extent(-180.0, -90.0, 180.0, 90.0, TDTSR);
//天地图服务器地址
...
var TDT=declare("TDT",[TiledMapServiceLayer],{
    //属性
    layerType:String,
    constructor:function(/**vec,img,cva*/layerType:String="vec"){
