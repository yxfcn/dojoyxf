define(["require", "exports", "esri/geometry/Extent", "esri/layers/TileInfo", "esri/SpatialReference", "esri/layers/TiledMapServiceLayer", "dojo/_base/declare"], function (require, exports, Extent, TileInfo, SpatialReference, TiledMapServiceLayer, declare) {
    "use strict";
    /**----------定义一些常量------ */
    //----------------天地图相关---------------//
    //天地图GCS2000坐标系
    ...
    var TDT = declare("TDT", [TiledMapServiceLayer], {
        //属性
        layerType: String,
        constructor: function (/**vec,img,cva*/ layerType) {
            if (layerType === void 0) { layerType = "vec"; }
        ...
        getTileUrl: function (level, row, col) {
            return "http://t" + this.sub + ".tianditu.com/" + this.layerType + "_c/wmts?SERVICE=WMTS&VERSION=1.0.0&REQUEST=GetTile&LAYER=" + this.layerType + "&STYLE="
                + "default&FORMAT=&TILEMATRIXSET=c&TILEMATRIX=" + level + "&TILEROW=" + row + "&TILECOL=" + col + "&format=tiles";
        }
    });
    return TDT;
